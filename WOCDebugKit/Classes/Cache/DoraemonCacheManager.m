...
/// 开关控制
static NSString * const kDoraemonMamawangDebugBuilderKey = @"kDoraemonMamawangDebugBuilderKey";
...
- (void)saveDaraemonKitSwitch:(BOOL)on{
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setBool:on forKey:kDoraemonMamawangDebugBuilderKey];
    [defaults synchronize];
}

- (BOOL)daraemonKitSwitch{
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    return [defaults boolForKey:kDoraemonMamawangDebugBuilderKey];
}
