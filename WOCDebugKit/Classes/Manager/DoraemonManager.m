...
- (void)initData{
    #pragma mark - 平台工具
    [self addPluginWithPluginType:DoraemonManagerPluginType_Doraemon_2d];
    [self addPluginWithPluginType:DoraemonManagerPluginType_Doraemon_3d];
    [self addPluginWithPluginType:DoraemonManagerPluginType_Doraemon_ScreenFit];
...
- (DoraemonManagerPluginTypeModel *)getDefaultPluginDataWithPluginType:(DoraemonManagerPluginType)pluginType
{
    NSArray *dataArray = @{
                          ...
                          @(DoraemonManagerPluginType_DoraemonHierarchyPlugin) : @[
                           ...
                           @(DoraemonManagerPluginType_Doraemon_2d) : @[
                                   @{kTitle:@"2D查看"},
                                   @{kDesc:@""},
                                   @{kIcon:@"doraemon_viewmetrics"},
                                   @{kPluginName:@"PHView2DPlugin"},
                                   @{kAtModule:@"常用工具"}
                           ],
                           @(DoraemonManagerPluginType_Doraemon_3d) : @[
                                   @{kTitle:@"3D查看"},
                                   @{kDesc:@""},
                                   @{kIcon:@"doraemon_viewmetrics"},
                                   @{kPluginName:@"PHView3DPlugin"},
                                   @{kAtModule:@"常用工具"}
                           ],
                           @(DoraemonManagerPluginType_Doraemon_ScreenFit) : @[
                                   @{kTitle:@"屏幕适配"},
                                   @{kDesc:@""},
                                   @{kIcon:@"doraemon_app_info"},
                                   @{kPluginName:@"PHScreenFitPlugin"},
                                   @{kAtModule:@"常用工具"}
                           ],
                           // 平台工具
